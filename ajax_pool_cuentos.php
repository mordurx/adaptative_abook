...
$sql1= "SELECT Cuento.id_cuento,nombre,imagen,ind_pagina FROM Cuento inner join Cuento_por_Usuario on Cuento.id_cuento=Cuento_por_Usuario.id_cuento where veces_leido<2 and id_usuario='$username'";
